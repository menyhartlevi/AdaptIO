...
A tanítás során egy módosított Main_learning.py fájlt futtatva, a Player_learning.py-ban lévő játékos algoritmusokat használva tanítottuk az agentet. Ezek a fájlok is feltöltésre kerültek.
